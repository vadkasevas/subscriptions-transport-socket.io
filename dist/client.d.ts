...
import { IClientAdapter, ReadyState } from './client-adapters/clientAdapterInterface';
...
export declare class SubscriptionClient {
    ...
    constructor(url: string, options?: ClientOptions, webSocketImpl?: any, wsOpts?: Object);
