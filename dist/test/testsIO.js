...
var socketIOServerAdapter_1 = require("../server-adapters/socketIOServerAdapter");
var __1 = require("..");
var TEST_PORT = 5953;
...
new server_1.SubscriptionServer(options, { server: httpServer }, socketIOServerAdapter_1.SocketIOServerAdapter);
var httpServerWithKA = http_1.createServer(notFoundRequestListener);
httpServerWithKA.listen(KEEP_ALIVE_TEST_PORT);
new server_1.SubscriptionServer(Object.assign({}, options, { keepAlive: 500 }), {
    server: httpServerWithKA,
}, socketIOServerAdapter_1.SocketIOServerAdapter);
var httpServerWithEvents = http_1.createServer(notFoundRequestListener);
httpServerWithEvents.listen(EVENTS_TEST_PORT);
var eventsServer = new server_1.SubscriptionServer(eventsOptions, {
...
new server_1.SubscriptionServer(onConnectErrorOptions, {
...
}), { server: httpServerWithDelay }, socketIOServerAdapter_1.SocketIOServerAdapter);
describe('Client socket.io', function () {
    var wsServer;
    beforeEach(function () {
        wsServer = io.listen(RAW_TEST_PORT);
    });
    afterEach(function () {
        if (wsServer) {
            wsServer.close();
    ...
    it('should send GQL_CONNECTION_INIT message when creating the connection', function (done) {
        ...
        new client_1.SubscriptionClient("http://localhost:" + RAW_TEST_PORT + "/", null, __1.SocketIOClientAdapter);
    });
    it('should send GQL_CONNECTION_INIT message first, then the GQL_START message', function (done) {
        var initReceived = false;
        var sub;
        var client = new client_1.SubscriptionClient("http://localhost:" + RAW_TEST_PORT + "/", null, __1.SocketIOClientAdapter);
        wsServer.on('connection', function (connection) {
            connection.on('message', function (message) {
                var parsedMessage = JSON.parse(message);
                if (parsedMessage.type === message_types_1.default.GQL_CONNECTION_INIT) {
                    connection.send(JSON.stringify({
                        type: message_types_1.default.GQL_CONNECTION_ACK,
                        payload: {},
                    }));
                    initReceived = true;
                }
    ...
    it('should emit connect event for client side when socket is open', function (done) {
        var client = new client_1.SubscriptionClient("http://localhost:" + TEST_PORT + "/", null, __1.SocketIOClientAdapter);
    ...
    it('should emit disconnect event for client side when socket closed', function (done) {
        var client = new client_1.SubscriptionClient("http://localhost:" + TEST_PORT + "/", {
            connectionCallback: function () {
                client.client.close();
            },
        }, __1.SocketIOClientAdapter);
    ...
    it('should emit connecting event for client side when socket closed', function (done) {
        var subscriptionsClient = new client_1.SubscriptionClient("http://localhost:" + TEST_PORT + "/", null, __1.SocketIOClientAdapter);
    ...
    it('should emit reconnecting event for client side when socket closed', function (done) {
        var subscriptionsClient = new client_1.SubscriptionClient("http://localhost:" + TEST_PORT + "/", {
            reconnect: true,
            reconnectionAttempts: 1,
            connectionCallback: function () {
    ...
    it('should send connectionParams along with init message', function (done) {
        ...
        new client_1.SubscriptionClient("http://localhost:" + RAW_TEST_PORT + "/", {
            connectionParams: connectionParams,
        }, __1.SocketIOClientAdapter);
    });
    it('should override OperationOptions with middleware', function (done) {
        var client3 = new client_1.SubscriptionClient("http://localhost:" + TEST_PORT + "/", null, __1.SocketIOClientAdapter);
    ...
    it('should handle connection_error message and handle server that closes connection', function (done) {
        ...
        wsServer.on('connection', function (connection) {
            connection.on('message', function (message) {
                ...
                setTimeout(function () {
                    chai_1.expect(client.status).to.equals(clientAdapterInterface_1.ReadyState.CLOSED);
                    done();
                }, 500);
            });
        });
        client = new client_1.SubscriptionClient("http://localhost:" + RAW_TEST_PORT + "/", null, __1.SocketIOClientAdapter);
    });
    ...
    it('should not connect until subscribe is called if lazy mode', function (done) {
        var client = new client_1.SubscriptionClient("http://localhost:" + RAW_TEST_PORT + "/", {
            lazy: true,
        }, __1.SocketIOClientAdapter);
    ...
    it('should reconnect to the server', function (done) {
        ...
        client = new client_1.SubscriptionClient("http://localhost:" + RAW_TEST_PORT + "/", {
            reconnect: true,
        }, __1.SocketIOClientAdapter);
    ...
    it('should throw an exception when trying to request when socket is closed', function (done) {
        var client = null;
        client = new client_1.SubscriptionClient("http://localhost:" + TEST_PORT + "/", {
            reconnect: true,
        }, __1.SocketIOClientAdapter);
        setTimeout(function () {
            client.client.close();
    ...
    it('should stop trying to reconnect to the server', function (done) {
        ...
        var subscriptionsClient = new client_1.SubscriptionClient("http://localhost:" + RAW_TEST_PORT + "/", {
            timeout: 500,
            reconnect: true,
    ...
    it('should take care of received keep alive', function (done) {
        ...
        var subscriptionsClient = new client_1.SubscriptionClient("http://localhost:" + KEEP_ALIVE_TEST_PORT + "/", { timeout: 600 }, __1.SocketIOClientAdapter);
        var originalOnMessage = subscriptionsClient.client.onmessage;
        subscriptionsClient.client.onmessage = function (dataReceived) {
            var receivedDataParsed = JSON.parse(dataReceived);
        ...
        setTimeout(function () {
            ...
            chai_1.expect(subscriptionsClient.status).to.equal(clientAdapterInterface_1.ReadyState.CLOSED);
            done();
        }, 1200);
    });
    it('should correctly clear timeout if receives ka too early', function (done) {
        ...
        setTimeout(function () {
            ...
            chai_1.expect(subscriptionsClient.status).to.be.equal(clientAdapterInterface_1.ReadyState.OPEN);
            done();
        }, 1300);
    });
    it('should take care of invalid message received', function (done) {
        var subscriptionsClient = new client_1.SubscriptionClient("http://localhost:" + RAW_TEST_PORT + "/", null, __1.SocketIOClientAdapter);
        var originalOnMessage = subscriptionsClient.client.onmessage;
        var dataToSend = JSON.stringify({ type: 'invalid' });
        chai_1.expect(function () {
    ...
    it('should delete operation when receive a GQL_COMPLETE', function (done) {
        ...
        var dataToSend = JSON.stringify({
            id: 1,
            type: message_types_1.default.GQL_COMPLETE,
        });
    ...
    it('should force close the connection without tryReconnect', function (done) {
        ...
        setTimeout(function () {
            ...
            chai_1.expect(subscriptionsClient.status).to.be.equal(clientAdapterInterface_1.ReadyState.CLOSED);
            done();
        }, 500);
    });
...
describe('Server socket.io', function () {
    ...
    it('should throw an exception when creating a server without execute', function () {
        chai_1.expect(function () {
            new server_1.SubscriptionServer({ execute: undefined }, { server: httpServer }, socketIOServerAdapter_1.SocketIOServerAdapter);
        }).to.throw();
    });
    it('should throw an exception when creating a server with subscribe only', function () {
        chai_1.expect(function () {
            new server_1.SubscriptionServer({ subscribe: {} }, { server: httpServer }, socketIOServerAdapter_1.SocketIOServerAdapter);
        }).to.throw();
    });
    it('should throw an exception when execute is missing', function () {
        chai_1.expect(function () {
            new server_1.SubscriptionServer({}, { server: httpServer }, socketIOServerAdapter_1.SocketIOServerAdapter);
        }).to.throw();
    });
    it('should throw an exception when using execute but schema is missing', function () {
        chai_1.expect(function () {
            new server_1.SubscriptionServer({ execute: {} }, { server: httpServer }, socketIOServerAdapter_1.SocketIOServerAdapter);
        }).to.throw();
    });
    it('should accept execute method than returns a Promise (original execute)', function (done) {
        ...
        var client = new client_1.SubscriptionClient("http://localhost:" + SERVER_EXECUTOR_TESTS_PORT + "/", null, __1.SocketIOClientAdapter);
    ...
    it('should handle socket error and close the connection on error', function (done) {
        ...
        }, { server: httpServerForError }, socketIOServerAdapter_1.SocketIOServerAdapter);
        var client = new client_1.SubscriptionClient("http://localhost:" + ERROR_TEST_PORT + "/", null, __1.SocketIOClientAdapter);
        client.onDisconnected(spy);
    });
    it('should trigger onConnect when client connects and validated', function (done) {
        new client_1.SubscriptionClient("http://localhost:" + EVENTS_TEST_PORT + "/", null, __1.SocketIOClientAdapter);
        setTimeout(function () {
    ...
    it('should trigger onConnect with the correct connectionParams', function (done) {
        ...
        new client_1.SubscriptionClient("http://localhost:" + EVENTS_TEST_PORT + "/", {
            connectionParams: connectionParams,
        }, __1.SocketIOClientAdapter);
        setTimeout(function () {
            chai_1.assert(eventsOptions.onConnect.calledOnce);
    ...
    it('should trigger onConnect and return GQL_CONNECTION_ERROR with error', function (done) {
        ...
        var subscriptionsClient = new client_1.SubscriptionClient("http://localhost:" + ONCONNECT_ERROR_TEST_PORT + "/", {
            connectionCallback: connectionCallbackSpy,
        }, __1.SocketIOClientAdapter);
        setTimeout(function () {
            chai_1.expect(connectionCallbackSpy.calledOnce).to.be.true;
            chai_1.expect(connectionCallbackSpy.getCall(0).args[0]).to.eql({
                message: 'Error',
            });
            subscriptionsClient.close();
            done();
    ...
    it('should trigger onDisconnect when client disconnects', function (done) {
        var client = new client_1.SubscriptionClient("http://localhost:" + EVENTS_TEST_PORT + "/", null, __1.SocketIOClientAdapter);
        setTimeout(function () {
            client.client.close();
        }, 100);
        setTimeout(function () {
    ...
    it('should send correct results to multiple clients with subscriptions', function (done) {
        var client = new client_1.SubscriptionClient("http://localhost:" + TEST_PORT + "/", null, __1.SocketIOClientAdapter);
        var client1 = new client_1.SubscriptionClient("http://localhost:" + TEST_PORT + "/", null, __1.SocketIOClientAdapter);
        var numResults = 0;
        setTimeout(function () {
            client
                .request({
        ...
        var client11 = new client_1.SubscriptionClient("http://localhost:" + TEST_PORT + "/", null, __1.SocketIOClientAdapter);
        var numResults1 = 0;
        setTimeout(function () {
            client11
                .request({
    ...
    it('should set up the proper filters when subscribing', function (done) {
        var numTriggers = 0;
        var client3 = new client_1.SubscriptionClient("http://localhost:" + TEST_PORT + "/", null, __1.SocketIOClientAdapter);
        var client4 = new client_1.SubscriptionClient("http://localhost:" + TEST_PORT + "/", null, __1.SocketIOClientAdapter);
        setTimeout(function () {
            client3
                .request({
    ...
    it('does not send more subscription data after client unsubscribes', function (done) {
        ...
        client4.client.onmessage = function (message) {
            if (JSON.parse(message).type === message_types_1.default.GQL_DATA) {
                chai_1.assert(false);
            }
        };
        sub = client4
    ...
    it('rejects a client that does not specify a supported protocol', function (done) {
        var client = ioClient("http://localhost:" + TEST_PORT + "/", {
    ...
    it('rejects unparsable message', function (done) {
        var client = ioClient("http://localhost:" + TEST_PORT + "/", {
            query: {
                protocol: protocol_1.GRAPHQL_SUBSCRIPTIONS,
            },
        });
    ...
    it('sends a keep alive signal in the socket', function (done) {
        var client = ioClient("http://localhost:" + KEEP_ALIVE_TEST_PORT + "/", {
            query: {
                protocol: protocol_1.GRAPHQL_SUBSCRIPTIONS,
            },
        });
...
describe('Client<->Server Flow socket.io', function () {
    var server;
    afterEach(function () {
        if (server) {
            server.close();
    ...
    it('should reconnect after inactivityTimeout closing the connection and then resubscribing', function (done) {
        ...
        var client = new client_1.SubscriptionClient("http://localhost:" + SERVER_EXECUTOR_TESTS_PORT + "/", {
            inactivityTimeout: 100,
        }, __1.SocketIOClientAdapter);
    ...
    it('should close iteration over AsyncIterator when client unsubscribes', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    client2 = _a.sent();
                    subscriptionsPubSub.publish(TEST_PUBLICATION, {
                        somethingChanged: 'test-payload',
                    });
                    return [4, wait(400)];
                case 3:
                    _a.sent();
                ...
                case 4:
                    _a.sent();
                    subscriptionsPubSub.publish(TEST_PUBLICATION, {
                        somethingChanged: 'test-payload-2',
                    });
                    return [4, wait(400)];
                case 5:
                    _a.sent();
...
//# sourceMappingURL=testsIO.js.map