...
var serverAdapterInterface_1 = require("./server-adapters/serverAdapterInterface");
var nativeServerAdapter_1 = require("./server-adapters/nativeServerAdapter");
var SubscriptionServer = (function () {
    function SubscriptionServer(options, socketOptions, webSocketImpl) {
        var _this = this;
        ...
        this.wsImpl = webSocketImpl || nativeServerAdapter_1.NativeServerAdapter;
        ...
        var connectionHandler = function (socket, request) {
            ...
            if (socket.protocol === undefined ||
                (socket.protocol.indexOf(protocol_1.GRAPHQL_WS) === -1 &&
                    socket.protocol.indexOf(protocol_1.GRAPHQL_SUBSCRIPTIONS) === -1)) {
                socket.close(1002);
                return;
            }
    ...
    SubscriptionServer.create = function (options, socketOptions, webSocketImpl) {
                    ...
                    connectionContext.initPromise
                        ...
                        if (_this.keepAlive) {
                            ...
                            var keepAliveTimer_1 = setInterval(function () {
                                if (connectionContext.socket.state === serverAdapterInterface_1.State.OPEN) {
                                    _this.sendKeepAlive(connectionContext);
                                }
                                else {
                ...
                case message_types_1.default.GQL_START:
                    connectionContext.initPromise
                        ...
                        promisedParams
                            ...
                            var document = typeof baseParams.query !== 'string'
                                ? baseParams.query
                                : graphql_1.parse(baseParams.query);
                            var executionPromise;
                            var validationErrors = graphql_1.validate(_this.schema, document, _this.specifiedRules);
                            if (validationErrors.length > 0) {
                                ...
                                var executor = _this
                                    .execute;
                                if (_this.subscribe &&
                                    is_subscriptions_1.isASubscriptionOperation(document, params.operationName)) {
                                    executor = _this.subscribe;
                                }
                                executionPromise = Promise.resolve(executor(_this.schema, document, _this.rootValue, params.context, params.variables, params.operationName));
                            }
                            return executionPromise.then(function (executionResult) { return ({
                                executionIterable: iterall_1.isAsyncIterable(executionResult)
                                    ? executionResult
                                    : iterall_1.createAsyncIterator([executionResult]),
                                params: params,
                            }); });
                        })
                            .then(function (_a) {
    ...
    SubscriptionServer.prototype.sendMessage = function (connectionContext, opId, type, payload) {
        ...
        if (parsedMessage && connectionContext.socket.state === serverAdapterInterface_1.State.OPEN) {
    ...
    SubscriptionServer.prototype.sendError = function (connectionContext, opId, errorPayload, overrideDefaultErrorType) {
        ...
        if ([message_types_1.default.GQL_CONNECTION_ERROR, message_types_1.default.GQL_ERROR].indexOf(sanitizedOverrideDefaultErrorType) === -1) {
